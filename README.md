...
```shell
kubectl port-forward service/www-tomshley-com-contactnotify-service-nlb 8181:80 -n www-tomshley-com-contactnotify-service-namespace
```
```shell
kubectl port-forward service/www-tomshley-com-contactnotify-service-k8service 8181:9900 -n www-tomshley-com-contactnotify-service-namespace
kubectl port-forward pod/www-tomshley-com-contactnotify-service-5fb58d8b5f-8wbls 8181:9900 -n www-tomshley-com-contactnotify-service-namespace
```
```shell
...
```
```shell
kubectl get pod/www-tomshley-com-contactnotify-service-5fb58d8b5f-8wbls -n www-tomshley-com-contactnotify-service-namespace --template='{{(index (index .spec.containers 0).ports 0).containerPort}}{{"\n"}}'
```
```shell
kubectl exec --stdin --tty www-tomshley-com-contactnotify-service-7f8fbd4449-4whwm -- /bin/bash
curl api.ipify.org
