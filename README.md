...
export TWILIO_ACCOUNT_SID_BASE64=$(echo -n "$TWILIO_ACCOUNT_SID" | base64 -w 0);
export TWILIO_AUTH_TOKEN_BASE64=$(echo -n "$TWILIO_AUTH_TOKEN" | base64 -w 0);
export TWILIO_PHONE_NUMBER_BASE64=$(echo -n "$TWILIO_PHONE_NUMBER" | base64 -w 0);
export CONTACTNOTIFY_NUMBERS_PIPEDEL_BASE64=$(echo -n "$CONTACTNOTIFY_NUMBERS_PIPEDEL" | base64 -w 0);
...
envsubst < kubernetes/config-notify-numbers.yml | kubectl apply -f -
