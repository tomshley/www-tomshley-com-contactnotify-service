...
val contactService =
  publishableProject("www-tomshley-com-contactnotify-service", Some(file(".")))
    ...
    .settings(
      ...
      dockerUsername := Some("www-tomshley-com-contactnotify-service"),
      ...
      libraryDependencies += "com.sendgrid" % "sendgrid-java" % "4.10.1"
    )
    .sourceDependency(
      ProjectRef(
        file(
